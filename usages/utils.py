...
def get_warpped_model(args, model):
    ...
    if args.task == "cls":
        if args.usage == "lp":
            ...
            model_warpped = LoRAWarpper(model, lora_targets=model_setting["lora_targets"])
        else:
